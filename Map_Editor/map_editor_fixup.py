...
from Map_Editor.inputs.new_things_inputs import h_inputs
...
from Map_Editor.inputs.mouse_inputs import place_object, place_tile
        ...
        for event in pygame.event.get():
            match event.type:
                ...
                case pygame.MOUSEBUTTONDOWN:
                    ...
                    if not tx < 0:
                        for name, obj in map_editor.objects_data.items():
                            if obj["x"] == tx and obj["y"] == ty:
                                screen_x = (obj["x"] - map_editor.camera_x) * VIEW_WIDTH
                                screen_y = (obj["y"] - map_editor.camera_y) * VIEW_HEIGHT
                                map_editor.renderer.draw_tooltip(name, obj["object_type"], screen_x, screen_y)
                                break
                    ...
                    match event.button:
                        case 1:
                            if self.placing_mode == "tile":
                                ...
                                place_object(self, event, tx, ty, keys_at_tile, mods)
                            record_additions(self)
                        case 3:
                ...
                case pygame.MOUSEMOTION:
                    ...
                    elif self.dragged_object_key and self.ghost_object:
